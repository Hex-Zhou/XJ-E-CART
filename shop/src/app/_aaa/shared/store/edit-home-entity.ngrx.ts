...
export const ACTIONS_EditHomeEntity = {
	setAll,
	add,
	update,
	del,
...
export const selectEditHomeEntityList = createSelector(
	featSelector,
	adapter.getSelectors().selectAll
);
// * * * * * effects * * * * *
@Injectable()
export class EditHomeEntityEffects {
	constructor(private actions$: Actions, private serv: ApiEditHomeEntityService) {}
	setAll$ = createEffect(() => {
